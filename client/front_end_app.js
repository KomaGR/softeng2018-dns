...
class Front_end_app {
    ...
    config() {
        ...
        this.front_end_app.get("/map", function (req, res) {
            res.render("map.ejs");
        });
    ...
    staticConfig() {
        ...
        this.front_end_app.use('/js', express.static('client/pages/js'));
        this.front_end_app.use('/lib', express.static('client/pages/lib'));
    }
}
